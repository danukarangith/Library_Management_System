...
import lk.ijse.Controller.Table_Row.Update.UpdateBranchFormControler;
import lk.ijse.Controller.Table_Row.View.ViewBranchFormController;
...
public class BranchRowController {
    ...
    public void editBtnOnActhion(ActionEvent actionEvent) {
        ...
        try {
            Parent parent = fxmlLoader.load();
            UpdateBranchFormControler controller = fxmlLoader.getController();
            controller.setData(branchDto);
            Stage stage = new Stage();
            stage.setScene(new Scene(parent));
            stage.show();
